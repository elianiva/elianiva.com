...
**./src/routes/__root.tsx** — Update existing root route:
...
- Astro's head injection -> React Helmet Async or manual meta tags in __root.tsx head()
...
### What This Replaces
- ./src/layouts/MainLayout.astro -> __root.tsx + individual layout components
