...
Current: Single __root.tsx with inline layout
- MainLayout: ✅ Converted to __root.tsx + components
...
- src/layouts/*.astro (replaced by __root.tsx)
- src/models/*.ts (types moved to content-collections or types/)
- src/pages/*.astro (replaced by routes/*.tsx)
