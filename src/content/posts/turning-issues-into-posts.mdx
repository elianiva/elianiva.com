...
If you don't know already, I'm using [Astro](https://astro.build/) to build this website. The code is hosted publicly at [elianiva/elianiva.com](https://github.com/elianiva/elianiva.com) if you want to check it out.

The posts are written in [markdown (.mdx) files](https://github.com/elianiva/elianiva.com/blob/master/src/content/posts/) so if I want to add a new post, I have to create a new file, make a commit, and then push it to trigger the deployment. Unlike a traditional CMS where you have this fancy dashboard that you can use, this one is pretty barebones, and I like it this way. It allows me to use any text editors I want to edit the contents--oh, I use [Neovim](https://neovim.io), btw.
...
<small class="block opacity-70 -mt-4 mb-4">
  Yeah, he vibe coded this, that's why it looks a bit dodgy, he probably improved it or something in
  his repo but this is the one I took
</small>
...
const type =
  issue.labels?.find((label) => label.name.startsWith("type:"))?.name.split(":")[1] || "";
...
[fail-1]: https://github.com/elianiva/elianiva.com/issues/42
[fail-2]: https://github.com/elianiva/elianiva.com/issues/43
[fail-3]: https://github.com/elianiva/elianiva.com/issues/44
[fail-4]: https://github.com/elianiva/elianiva.com/issues/45
[fail-5]: https://github.com/elianiva/elianiva.com/issues/46
...
- [My Workflow File](https://github.com/elianiva/elianiva.com/blob/master/.github/workflows/bookmark-til.yml)
