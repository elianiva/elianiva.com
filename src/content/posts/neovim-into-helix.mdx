...
It will probably get outdated very quickly since I might have to change a thing or two as I'm adjusting to use it, so you can check it yourself in [my dotfiles repository](https://github.com/elianiva/dotfiles)
