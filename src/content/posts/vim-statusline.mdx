...
date: 2020-02-15
description: A post where I made my own statusline to make my vim looks more personalised
tags:
    - neovim
---
...
I wrote a better version of this in Lua which you can read [here](https://elianiva.com/posts/neovim-lua-statusline)
