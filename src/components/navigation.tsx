        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "h-full px-4 text-xs font-normal transition-colors border-r border-border flex items-center uppercase font-heading tracking-widest text-foreground/70 active:bg-border/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-400 focus-visible:ring-offset-2 whitespace-nowrap shrink-0",
