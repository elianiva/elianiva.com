  ...
  return (
    <div className="relative mb-8">
      <div className="flex justify-between items-center">
        <span className="text-xl font-bold font-heading text-pink-950">{institution}</span>
        <span className="text-lg font-medium font-heading text-pink-950/70">
          {startDate} - {finishDate}
        </span>
      </div>
      <span className="text-base text-pink-950/70 font-body block">GPA: {gpa} (current)</span>
