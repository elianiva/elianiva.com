...
export function CodeCopy() {
  ...
  useEffect(() => {
    ...
    preElements.forEach((pre) => {
      ...
      button.className =
        "group/button relative inline-flex shrink-0 items-center justify-center rounded-none border border-transparent bg-clip-padding text-xs font-medium whitespace-nowrap outline-none select-none absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity bg-white/80 border-pink-200 p-1.5 text-pink-700 hover:bg-white hover:text-pink-900 focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 size-7";
