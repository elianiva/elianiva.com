export function Frame() {
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-20 h-6 bg-yellow-300 z-50 group cursor-pointer flex items-center justify-center transition-transform  border-2 border-pink-200 border-t-0 border-l-0"></div>
    </>
  );
}
