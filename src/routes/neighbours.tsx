  ...
  return (
    <div className="mx-auto max-w-container pt-10 border-x border-pink-200/50 min-h-screen">
      <div className="py-4 md:py-8 px-2 md:px-8">
        <section className="relative pb-8 with-box-underline">
        ...
        <section className="grid gap-3 grid-cols-2 md:grid-cols-3 py-8">
          {[...neighbours]
            ...
            .map((neighbour) => (
              <a
                ...
                className="group relative border border-pink-200/50 bg-gradient-to-br from-white/60 via-pink-50/30 to-orange-50/20 p-4 hover:bg-white/80 transition-all duration-200 block"
              >
                {/* Corner squares — matching hero section aesthetic */}
